...
import { GravelCalculatorForm } from "@/components/tools/gravel-calculator-form";
import { FaqJsonLd } from "@/components/seo/faq-jsonld";
import { buttonVariants } from "@/components/ui/button";
import { cn } from "@/lib/utils";
import { GRAVEL_CALCULATOR_FAQS } from "@/lib/tool-faqs";

export const metadata: Metadata = {
  title: "Free Gravel Calculator",
  description:
    "Estimate cubic yards, tons, and bag count of gravel or decorative rock for a path, ground cover, or drainage area — a free planning calculator from Vegas Hardscape Design.",
  alternates: {
    canonical: "/tools/gravel-calculator",
  },
};
...
export default function GravelCalculatorPage() {
  return (
    <>
      <FaqJsonLd faqs={GRAVEL_CALCULATOR_FAQS} />
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-4xl px-6 py-24 text-center lg:px-10">
          ...
          <p className="mt-6 text-sm text-muted-foreground sm:text-base">
            Enter your coverage area and depth to estimate cubic yards,
            tons, and bag count for gravel, crushed stone, or decorative
            rock.
          </p>
        </div>
      </section>
      ...
      <section className="border-t border-border bg-secondary/40">
        <div className="mx-auto max-w-4xl px-6 py-24 lg:px-10">
          ...
          <div className="mt-16 flex flex-col divide-y divide-border">
            {GRAVEL_CALCULATOR_FAQS.map((faq) => (
