...
import { MulchCalculatorForm } from "@/components/tools/mulch-calculator-form";
import { FaqJsonLd } from "@/components/seo/faq-jsonld";
import { buttonVariants } from "@/components/ui/button";
import { cn } from "@/lib/utils";
import { MULCH_CALCULATOR_FAQS } from "@/lib/tool-faqs";

export const metadata: Metadata = {
  title: "Free Mulch Calculator",
  description:
    "Estimate cubic yards and bag count of mulch for your planting beds — a free planning calculator from Vegas Hardscape Design.",
  alternates: {
    canonical: "/tools/mulch-calculator",
  },
};
...
export default function MulchCalculatorPage() {
  return (
    <>
      <FaqJsonLd faqs={MULCH_CALCULATOR_FAQS} />
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-4xl px-6 py-24 text-center lg:px-10">
          ...
          <p className="mt-6 text-sm text-muted-foreground sm:text-base">
            Enter your planting bed dimensions and depth to estimate cubic
            yards and bag count of mulch.
          </p>
        </div>
      </section>
