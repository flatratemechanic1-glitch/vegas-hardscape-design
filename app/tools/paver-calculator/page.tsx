...
import { PaverCalculatorForm } from "@/components/tools/paver-calculator-form";
import { FaqJsonLd } from "@/components/seo/faq-jsonld";
import { buttonVariants } from "@/components/ui/button";
import { cn } from "@/lib/utils";
import { PAVER_CALCULATOR_FAQS } from "@/lib/tool-faqs";
...
export default function PaverCalculatorPage() {
  return (
    <>
      <FaqJsonLd faqs={PAVER_CALCULATOR_FAQS} />
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-4xl px-6 py-24 text-center lg:px-10">
          ...
          <p className="mt-6 text-sm text-muted-foreground sm:text-base">
            Enter your patio or walkway dimensions to estimate how many
            pavers, how much compacted base, and how much bedding sand
            you&apos;ll need — a quick planning starting point before you
